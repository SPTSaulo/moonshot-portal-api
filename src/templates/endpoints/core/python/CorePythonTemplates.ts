...
export class CorePythonTemplates {

  public static version_get: EndpointTemplate = {
    name: "version",
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/version\"\n" +
      "\n" +
  ...
  public static signedUrl_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/signed-url?contentType=image/jpeg&filename=descarga.jpg\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
  ...
  public static openGraph_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      ...
      "\n" +
      "VIDEO_URL = \"https://youtu.be/08yBlI2XT8I\"\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core//openGraph?url=\" + VIDEO_URL\n" +
      "\n" +
      "response = reqs.get(\n" +
      "    URL, \n" +
      "    headers={\"Content-Type\": \"application/x-www-form-urlencoded\"}, \n" +
      "    auth=HTTPBasicAuth('username', 'passord'))\n" +
      "print(response.text)",
    response: "\n{\n" +
  ...
  public static navbar_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/navbar\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
    response: "\n{\n" +
  ...
  public static industries_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/industries\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
    response: "\n[\n" +
  ...
  public static businessModels_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/business-models\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
    response: "\n[\n" +
  ...
  public static socialInnovations_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/social-innovations\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
    response: "\n[\n" +
  ...
  public static deepTechs_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/deep-techs\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
    response: "\n[\n" +
  ...
  public static ecosystem_upload_original_post: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/ecosystems/upload/original\"\n" +
      "\n" +
  ...
  public static ecosystem_upload_thumbnail_post: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/ecosystems/upload/thumbnail\"\n" +
      "\n" +
      "response = reqs.put(URL, files={'file': open('YOUR_FILE', 'r')})\n" +
      "print(response.text)",
  ...
  public static ecosystem_id_upload_media_put: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/ecosystems/1/upload/media\"\n" +
      "\n" +
      "response = reqs.put(URL, files={'file': open('YOUR_FILE', 'r')})\n" +
      "print(response.text)",
  ...
  public static ecosystem_put: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/ecosystems/1\"\n" +
      "\n" +
      "BODY = {\n" +
      "  \"type\":\"CORPORATE\",\n" +
      "  \"name\":\"DEV  Moonshot\",\n" +
  ...
  public static notifications_pending_get: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/notifications/pending\"\n" +
      "\n" +
      "response = reqs.get(URL)\n" +
      "print(response.text)",
    response: "\n{\n" +
  ...
  public static setting_upload_original_post: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/settings/upload/original\"\n" +
      "\n" +
      "response = reqs.put(URL, files={'file': open('YOUR_FILE', 'r')})\n" +
      "print(response.text)",
  ...
  public static setting_upload_thumbnail_post: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/settings/upload/thumbnail\"\n" +
      "\n" +
      "response = reqs.put(URL, files={'file': open('YOUR_FILE', 'r')})\n" +
      "print(response.text)",
    response: "\nhttps://localhost/drive/settings/banner/thumbnail/61eaffcdad2bd12319fd4eba.png"
  }
  ...
  public static challenge_upload_media_post: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/challenges/upload/media\"\n" +
      "\n" +
      "response = reqs.put(URL, files={'file': open('YOUR_FILE', 'r')})\n" +
      "print(response.text)",
  ...
  public static challenge_upload_news_post: EndpointTemplate = {
    ...
    code: "\nimport requests as reqs\n" +
      "\n" +
      "URL = \"https://dev.moonshot.ceo/api/core/challenges/upload/news\"\n" +
      "\n" +
      "response = reqs.put(URL, files={'file': open('YOUR_FILE', 'r')})\n" +
      "print(response.text)",
